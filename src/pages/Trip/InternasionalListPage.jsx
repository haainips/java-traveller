...
function InternasionalListPage() {
    ...
    const regionData = trips.internasional[region];
    const [searchTerm, setSearchTerm] = useState("");
    const internasionalRegions = Object.keys(trips.internasional);
        ...
        <div className="px-20 py-10 mb-10 min-h-[60vh] 0">
            ...
            <div className="flex justify-end mt-8 mb-4">
                <Select onValueChange={handleRegionChange}>
                    ...
                    <SelectContent>
                        {internasionalRegions.map((regionName) => (
            ...
            {filteredTrips.length > 0 ? (
                ...
                <div className="grid grid-cols-3 gap-6">
                    {filteredTrips.map((trip) => (
                        <Link key={trip.id} to={`/Trip/internasional/${region}/${trip.slug}`}>
